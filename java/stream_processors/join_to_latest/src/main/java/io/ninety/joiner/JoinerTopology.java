...
public final class JoinerTopology {
	...
	public static Topology createTopology(Properties props) {
		...
		final TimestampExtractor timestampExtractor = AvroTimestampExtractor.create("event_time");
		final Consumed<String, GenericRecord> consumed = Consumed.with(Serdes.String(), avroSerde).withTimestampExtractor(timestampExtractor);
